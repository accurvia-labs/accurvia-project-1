        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center justify-center">
          ...
          <div className="relative flex flex-col justify-end">
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-4">
              <Link
                href=""
                className="inline-flex items-center justify-center h-11 sm:h-12 px-6 sm:px-8 bg-primary text-primary-foreground text-xs font-bold tracking-[0.14em] uppercase rounded-md hover:bg-primary/80 transition-all duration-200"
              >
                Book a Strategy Call
              </Link>
              <Link
                href=""
                className="inline-flex items-center justify-center gap-2 h-11 sm:h-12 px-6 sm:px-8 border border-primary text-primary text-xs font-bold tracking-[0.14em] uppercase rounded-md hover:bg-primary/5 transition-all duration-200"
              >
                The Portfolio
                <ArrowRight size={14} />
              </Link>
